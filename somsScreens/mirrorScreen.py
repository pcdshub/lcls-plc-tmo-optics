...
class MirrorScreen(Display):
    def __init__(self, parent=None, args=None, macros=None):
        ...
        self.alarm_gantry_x.channel = "ca://" + macros['BASE_PV'] + ":ALREADY_COUPLED_X_RBV"
        self.alarm_gantry_x.setMaximumHeight(35)
        self.alarm_gantry_x.setMaximumWidth(35)

        self.alarm_gantry_y = TyphosAlarmCircle()
        self.alarm_gantry_y.channel = "ca://" + macros['BASE_PV'] + ":ALREADY_COUPLED_Y_RBV"
        ...
        self.advanced_button.happi_names = [macros['DISP_NAME'].lower() + "_soms"]
